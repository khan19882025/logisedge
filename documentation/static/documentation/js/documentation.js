...
function initializePrintFunctionality() {
    // Handle print dropdown items
    const printDropdownItems = document.querySelectorAll('.dropdown-menu a[href*="print_"]');
        ...
        item.addEventListener('click', function(e) {
            ...
            if (url) {
                ...
                if (printWindow) {
                    ...
                    // Fallback: trigger print after a longer delay if load event doesn't fire
                    setTimeout(() => {
                        try {
                            printWindow.print();
                        } catch (e) {
                            console.log('Print triggered via fallback');
                        }
                    }, 3000);
                }
            }
